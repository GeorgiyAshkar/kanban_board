...
- **Проекты и блокировки карточек**: проект можно назначить при создании или редактировании задачи; у задачи можно указать статус блокировки, причину и ID карточки-блокера; блокеры подсвечиваются на доске и попадают в аналитику.
