...
- **Дорожки (swimlanes)** на доске: группировка по приоритету, исполнителю или проекту для визуализации параллельных потоков работ.
- **WIP/SLA flow-control** на колонках: лимиты незавершенной работы и предупреждения о просрочке SLA.
- **Блокировки карточек**: у задачи можно указать статус блокировки, причину и ID карточки-блокера; блокеры подсвечиваются на доске и попадают в аналитику.
