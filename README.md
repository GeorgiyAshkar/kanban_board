...
- На desktop карточки компактные (по заголовку) и раскрываются при наведении; на мобильных/планшетах карточки сразу показывают содержимое без hover-зависимости.
