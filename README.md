...
- **Альтернативные представления задач**: кроме канбан-доски доступны табличный вид для аудита карточек и календарный вид по дедлайнам/датам возврата.
...
- Доска поддерживает переключение между канбан-представлением, таблицей и календарем для планирования дедлайнов и просмотра задач с разной детализацией.
...
- Доработать календарь до полноценной месячной сетки с drag-and-drop переноса дат.
