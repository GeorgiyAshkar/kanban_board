...
interface Props {
  ...
  onExportBackup: (kind: 'json' | 'csv' | 'archive') => void;
    ...
    <section className="settings-page">
      ...
      <div className="settings-grid">
        ...
        <div className="settings-card">
          ...
          <div className="settings-row">
            <button className="small-btn" onClick={() => onExportBackup('json')}>Экспорт JSON</button>
            <button className="small-btn" onClick={() => onExportBackup('csv')}>Экспорт CSV</button>
            <button className="small-btn" onClick={() => onExportBackup('archive')}>Скачать архив</button>
          </div>
          <div className="settings-row">
